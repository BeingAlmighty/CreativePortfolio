    ...
    >
      ...
      >
        ...
        <div className='flex flex-col justify-center items-center w-full h-full'>
            ...
            {techStacks.map((tech, index) => (
              ...
              >
                <img
                  src={tech.image}
                  alt={tech.name}
                  className={`w-8 h-8 mb-2 ${tech.imgClass || ''}`}
                />
          ...
          {/* Desktop Scroll */}
          <div className='hidden sm:flex flex-col gap-3 xl:gap-3 p-3 w-full h-full overflow-hidden flex-1'>

            {/* Top Row */}
            <motion.div
              style={{ x: x1 }}
              className='flex w-max flex-1 min-h-0 items-stretch'
            >
              {[
                ...techStacks,
                ...techStacks,
                ...
                <div
                  key={`row1-${index}`}
                  className={`flex-shrink-0 h-full mx-2 p-3 xl:p-2 ${tech.bg} rounded-2xl xl:rounded-xl shadow-lg flex flex-col items-center justify-center min-w-[140px] xl:min-w-[130px] border border-white/5`}
                >
                  <img
                    src={tech.image}
                    alt={tech.name}
